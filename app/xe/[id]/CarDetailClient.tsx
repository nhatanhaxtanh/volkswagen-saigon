...
import { ArrowLeft, Phone, MessageCircle, CheckCircle, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-gray-50 pt-16">
      ...
      <div className="bg-[#001e50]">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center gap-2 text-sm text-white/60">
          <Link href="/" className="hover:text-white transition-colors">Trang chủ</Link>
          <span>/</span>
          <Link href="/xe" className="hover:text-white transition-colors">Các dòng xe</Link>
          <span>/</span>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid lg:grid-cols-2 gap-10 mb-16">
          ...
          <div className="space-y-3">
            {/* Main image */}
            <div className="relative aspect-[16/10] rounded-2xl overflow-hidden bg-white shadow-md group">
              <Image
              ...
              {car.gallery.length > 1 && (
                <>
                  <button
                    onClick={prevImg}
                    className="absolute left-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-black/30 hover:bg-black/50 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                    <ChevronLeft size={18} />
                  </button>
                  <button
                    onClick={nextImg}
                    className="absolute right-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-black/30 hover:bg-black/50 flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                ...
                {car.gallery.map((img, i) => (
                  <button
                    ...
                    className={cn(
                      ...
                      i === activeImg ? "border-blue-600 opacity-100" : "border-transparent opacity-60 hover:opacity-90"
                    )}
                  >
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-[#001e50] leading-tight mb-1">
              {car.name}
            </h1>
            <p className="text-gray-500 text-sm mb-5">{car.tagline}</p>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">{car.desc}</p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <a
                ...
                className={cn(
                  ...
                  "flex-1 bg-[#001e50] hover:bg-blue-800 text-white gap-2 justify-center"
                )}
              >
                <Phone size={17} />
                Gọi {PHONE}
              ...
              <a
                ...
                className={cn(
                  ...
                  "flex-1 border-blue-500 text-blue-600 hover:bg-blue-500 hover:text-white gap-2 justify-center"
                )}
              >
            ...
            <div className="grid grid-cols-2 gap-3 mt-6">
              {car.specs.slice(0, 4).map((s) => (
                <div key={s.label} className="bg-white rounded-xl p-3 border border-gray-100">
                  ...
                  <p className="text-[#001e50] font-semibold text-sm">{s.value}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div>
            <h2 className="text-xl font-bold text-[#001e50] mb-4 pb-2 border-b border-gray-200">
              Thông số kỹ thuật
            </h2>
        ...
        {related.length > 0 && (
          <div>
            <h2 className="text-xl font-bold text-[#001e50] mb-6 pb-2 border-b border-gray-200">
